...
class DirtInjector:
    ...
    def __init__(self, dirt_patch_folder):
        ...
        # Save n of variants
        self.variants = len(self.dirt_patch_paths)
    ...
    def inject(self, original_img_path, out_folder):
        ...
        for patch_path in self.dirt_patch_paths:
            logging.info(f"Applying Dirt Patch: {os.path.basename(patch_path)}")
            ...
            out_dir = FilePathManager.getVariantOutputFolder(out_folder, self.dirt_patch_paths.index(patch_path))
